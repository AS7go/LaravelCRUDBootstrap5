...
@section('title', isset($user) ? 'Users'.$user->name : 'Create user')
...
class="mt-3">
    ...
    <div class="row">
        <div class="col">
            <input name="name" value="{{ old('name', isset($user) ? $user->name : null) }}" type="text" class="form-control" placeholder="Name" aria-label="name">
            @error('name')
